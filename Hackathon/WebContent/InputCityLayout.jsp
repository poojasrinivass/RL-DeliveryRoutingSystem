...
<html lang="en">
  <head>
    ...
    <title>Input Layout of City</title>
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item active">
            <a class="nav-link" href="aboutUs.jsp"></a>
          </li>
        </ul>
...
<br>
	...
	<form method="post" action="facultyLoginCheck">
	  ...
	  <div class="wrapper">
	    <label for="uname"><b>Grid Length</b></label>
	    <input type="text" placeholder="Enter Username"  name="uname" required >
            <br>
            <label for="uname"><b>Grid Breadth</b></label>
	    <input type="text" placeholder="Enter Username"  name="uname" required >
            <br>
            <label for="uname"><b>Number of Shops</b></label>
	    <input type="text" placeholder="Enter Username"  name="uname" required >
            <br>
	    </div>
            <br>
        ...
        <div class="container" style="margin-bottom: 3vh;">
          <div class="row">
           ...
           <!-- <div class="col-lg-3 col-md-3">
              ...
              <div class="footer-content">SheHacks Hackathon </div>
            </div>
